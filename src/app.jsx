...
class App extends Component {
  config = {
    pages: [
      ...
      'pages/legendsUserCenter/incomeRecord/incomeRecord', // wangyu0605  注释
      'pages/legendsUserCenter/legendsUserCenter',   //wangyu0605 添加
      'pages/legendsCardRight/legendsCardRight',
      'pages/mine/mine',
      'pages/rightsDescription/rightsDescription',
      'pages/openLegendsCard/openLegendsCard',  // wangyu0605
    ...
    subpackages: [
      {
        ...
        pages: [
          ...
          'member/member',
          'propagandaRewardDetail/propagandaRewardDetail',
          'propagandaReward/propagandaReward',
          'legendsUserCenter/incomeRecord/incomeRecord',
          // 'legendsUserCenter/legendsUserCenter',
          'orderRemark/orderRemark',
          'couponList/couponList',
          // 'openLegendsCard/openLegendsCard',
        ]
      },
      {
        root: 'packageSecond',
        pages: [
          ...
          'packagePayConfirm/packagePayConfirm',
          'userAddressModify/userAddressModify',
        ]
      }
    ],
    preloadRule: {
  ...
  componentWillMount(){
    ...
    Taro.getSystemInfo({
      success:(res)=>{
          this.props.dispatch({
              type: 'common/setFullScreen',
              payload: res.statusBarHeight>20,
          })
          console.log("系统信息===========>", res);
          console.log("系统信息======statusBarHeight=====>", res.statusBarHeight);
      }
    })
    
    // 这里是给自定义默认首页使用的,需要在首页中知道是第一次进入还是其它页面跳转的
    // 第一次进入的是默认入口页，则返回true,否则返回false；
    let options = this.$router.params;
    console.log("options.path",options.path)
    this.props.dispatch({
      type: "common/setFirstIntoApp",
      payload: options.path === 'pages/index/index',
    })
  }
