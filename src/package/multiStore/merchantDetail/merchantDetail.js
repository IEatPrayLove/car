...
export default class merchantDetail extends Taro.Component {
  ...
  componentWillMount() {
    ...
    console.log('106 this.$router.params=>>>>>>>>',this.$router.params)
    const thirdNo = this.$router.params.thirdNo?this.$router.params.thirdNo:null;
    const merchantAvatar = this.$router.params.merchantAvatar?this.$router.params.merchantAvatar:null;
    const preId = this.$router.params.id?this.$router.params.id:null;
    const preBrandId = this.$router.params.brandId?this.$router.params.brandId:null;
    this.setState({
      thirdNo,
      merchantAvatar,
      preId,
  ...
  callbackGetWxtoken = (response,data)=>{
    if (response.data.code == 0) {
      ...
      console.log(brandGuid, diningTableGuid, storeGuid,openid);
      hideLoading();
        ...
        <View className="merchantBox">
          {
            !judgeIsPartner() && (
              <View
                ...
                onClick={() => Taro.reLaunch({ url: '/package/distributor/index/index' })}
              >
