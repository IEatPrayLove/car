...
//   objNotNull, encodeURIObj, needLogin
// } from '../../../utils/utils'
// import IconFont from '../../../components/IconFont/IconFont'
// import Payment from '../../../components/Payment/Payment'
// import { COUPON_CONDITION, PAY_WECHAT, PAYMENT, PAY_STORED } from '../../../config/config'
...
//       distributorProportion: this.$router.params.distributorProportion,
...
//       currentRedPackage: {},
//       confirmRedPackage: {},
//       distributionRatio: decodeURIObj(this.$router.params.ratio),
//       couponList: [],
//       payBoxVisible: false
//     }
//     this.wxCode = ''
...
//     return {
//       title: '优惠买单',
//       path: `/package/multiStore/preferentialPayment/preferentialPayment?payment=${this.$router.params.payment}&merchantInfo=${this.$router.params.merchantInfo}&ratio=${this.$router.params.ratio}&distributorProportion=${this.$router.params.distributorProportion}&code=${code || ''}`
//     }
//   }
...
//           </View>
//         </View>
//         <View className="saleTips">*输入不参与优惠金额(如酒水、套餐)</View>
//         <View className="saleBox">
//           <View className="saleItem">
