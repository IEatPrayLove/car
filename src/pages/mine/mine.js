...
export default class Mine extends PureComponent {
  ...
  goToLegendsCardUserCenter = () => {
    ...
    if (islandUserMemberDTO) {
      Taro.reLaunch({ url: '/package/distributor/index/index' })
    } else {
      // navToPage('/pages/dredgeUnionCard/dredgeUnionCard')
      navToPage('/pages/openLegendsCard/openLegendsCard') // 线上跳转的地方
    }
  }
      ...
      <Block>
        ...
        >
          <View className="flex-row">
            <Image
              className="userImg"
              mode="aspectFit"
              src={objNotNull(userInfo) ? getServerPic(headPic) : require('../../images/icon/not_login.png')}
          ...
          <View className="cardSection flex-row">
            {/* <View
              className={`memberCard flex-col flex-sb flex1 notStored`} // notStored
        ...
        <View className="userNav flex-row">
          ...
          >
            ...
            <Text className="title">消费记录</Text>
          </View>
          <View
            className="navItem flex-col flex-ac flex-gw flex-jc"
            hoverClass="clickHover"
          ...
          >
            ...
            <Text className="title">卡券权益</Text>
          </View>
          <View
            className="navItem flex-col flex-ac flex-gw flex-jc"
            hoverClass="clickHover"
        ...
        <View className="userManage">
          <AtList>
            <AtListItem
              ...
              onClick={() => {
                navToPage('/pages/distributorIndex/distributorIndex')
              }}
            />
            <AtListItem
              title="优惠券"
              ...
              onClick={() => {
                navToPage('/pages/userCoupons/userCoupons')
              }}
            />
            <AtListItem
              title="我的地址"
              ...
              onClick={() => { navToPage('/pages/userAddress/userAddress') }}
            />
            {/*<AtListItem*/}
            {/*title="商家入驻"*/}
            {/*arrow="right"*/}
            ...
            {/* {
              <AtListItem
                title='活动页面'
                arrow='right'
                thumb={`${STATIC_IMG_URL}/raiders_item1.png`}
                onClick={() => {
                  Taro.navigateTo({ url: '/pages/activePage/activePage' })
                }}
              />
            } */}
          </AtList>
