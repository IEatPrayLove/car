...
export default class LegendsUserCenter extends PureComponent {
  ...
  onShareAppMessage() {
    ...
    console.log('用户code:', `/package/legendsUserCenter/legendsUserCenter?code=${code || ''}`)
    return {
      title: `${nickName}邀请你开通会员卡享受商品自购返现，分享赚钱`,
      path: `/package/legendsUserCenter/legendsUserCenter?code=${code || ''}`,
      imageUrl: shareImage
    }
  }
          ...
          <View className="sharePartner flex-col flex-ac">
            ...
            <View className="shareIncome flex-row">
              ...
              <View
                ...
                onClick={() => {
                  navToPage('/package/legendsUserCenter/incomeRecord/incomeRecord')
                }}
              >
                <Text>收益记录</Text>
              </View>
            ...
            <Text
              className="prompt"
              onClick={() => {
                Taro.reLaunch({ url: '/pages/treasury/index' })
              }}
            >
