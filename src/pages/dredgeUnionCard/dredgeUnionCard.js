...
export default class dredgeUnionCard extends Taro.PureComponent {
  ...
  submitOrder = wxCode => {
    ...
    console.log(limitPrice, code, PLATFORM_ID, id, isWechat)
    dispatch({
      ...
      <View className="dredgeBox">
        ...
        <View className="dredgeHeader">
          ...
          <View className="dredgeRight ">
            ...
            {
              isRenew && <View className="dredgeWord">预计{dayjs(memberEndTime).format('YYYY-MM-DD')}到期</View>
            }
          </View>
        </View>
          ...
          modalVisible && (
            <View className="dredgeSuccessMask">
              <View className="dredgeSuccessBody">
                ...
                <View className="dredgeSuccessTitle">已开通会员卡</View>
                {
                  tcdReturnMoney && (
                ...
                <View
                  ...
                  onClick={() => {
                    Taro.reLaunch({ url: '/pages/distributorIndex/distributorIndex' })
                    this.setState({
                      modalVisible: false
                    })
                  }}
