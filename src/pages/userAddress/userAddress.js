...
class UserAddress extends Component {
  ...
  addAddress = (type, item, e) => {
    ...
    navToPage(`/packageSecond/userAddressModify/userAddressModify?oldAddress=${type === 'NEW' ? encodeURIObj({}) : encodeURIObj(item)}&formPage=${this.state.formPage}&range=${this.$router.params.rangeArea}&orderType=${this.$router.params.orderType}`)
  }
