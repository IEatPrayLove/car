              ...
              >
                {
                  parseFloat(profits.distruibutionTotalAmount).toFixed(2) === '0.00'
                    ? (
                      <View className="itemRightTitle" onClick={judgeLegendsCard(getUserDetail().islandUserMemberDTO) ? this.handleRouter('/pages/specialOffer/specialOffer') : this.handleRouter('/pages/dredgeUnionCard/dredgeUnionCard')}>
              ...
              >
                {
                  parseFloat(profits.promotionTotalAmount).toFixed(2) === '0.00'
                    ? (
                      <View className="itemRightTitle" onClick={isExpert ? this.handleRouter('/package/propagandaReward/propagandaReward') : this.handleRouter('/pages/achievementCertification/achievementCertification')}>
