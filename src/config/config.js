...
export const NAV_LINK = {
  0: '/package/propagandaReward/propagandaReward',
  1: '/pages/specialOffer/specialOffer',
  2: '/pages/dredgeUnionCard/dredgeUnionCard',
  ...
  6: '/pages/distributorIndex/distributorIndex',
  11: '/package/multiStore/merchantList/merchantList',
  12: '/package/multiStore/brandList/brandList',
  13: '/pages/orderDishes/orderDishes',
}
