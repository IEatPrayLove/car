...
// export const IP = DEV ? 'http://192.168.101.76:8080' : 'https://test.canyingdongli.com' // 代锐
// export const IP = 'http://192.168.101.117:8080' // 王颖
// export const IP = 'http://192.168.101.47:8080' // 马晓林
//  export const IP = 'http://0f9ef964.ngrok.io' // 代锐
...
export const IP = DEV ? 'https://test.canyingdongli.com' : 'https://clt.canyingdongli.com'
export const SERVER_IP = DEV ? 'test.canyingdongli.com' : 'clt.canyingdongli.com'  //test.canyingdongli.com
export const WEBSOCKET_IP_ORDERING = DEV ? 'ws://test.sandbox.canyingdongli.com:8086/websocket/person/' : 'wss://socketweixin.canyingdongli.com/websocket/person/'
export const WEBSOCKET_IP = DEV ? 'wss://socketweixin.canyingdongli.com' : 'wss://socketweixin.canyingdongli.com'

//掌控者平台mqtt连接地址
// export const OTHERWEBSOCKET_IP = DEV ? 'ws://192.168.102.37:9091' : 'ws://192.168.102.37:9091'     //马晓林   无线上地址，需要后台配置
export const OTHERWEBSOCKET_IP = DEV ? 'wss://socketweixin.canyingdongli.com' : 'wss://socketweixin.canyingdongli.com'
export const SERVICE_PORT = DEV ? '80' : '80'
export const DEFAULT_PLAT_FORM_ID = DEV ? 142 : 394  // 246 293 49 358 耗儿爷:122 多店:81  394.........   392    142
export const WEBSOCKET_PLATFORM = DEFAULT_PLAT_FORM_ID
export const APP_ID = DEV ? 85 : 95               // 赚餐平台编号 耗儿爷:83 多店:80  平台：95                          103     85
export const WX_APPID = DEV ? 'wx4b788f7d5151d9b5' : 'wxa3ed3c38f103be37'
